...
mean = Variable(torch.randn(2,)+13.)
print(mean.data.type())
'''
mean = Variable(tf.random_normal([2, ], 13., 1.), dtype=tf.float32)
cov = Variable(5. * tf.eye(DNA_SIZE), dtype=tf.float32)    
