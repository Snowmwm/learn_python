...
from model_localconv import Discriminator, Generator
...
MODEL_PATH_D = False #'./checkpoints/D_130.pkl'
MODEL_PATH_G = False #'./checkpoints/G_130.pkl'
...
#加载模型参数
if MODEL_PATH_D and MODEL_PATH_G:
